...
val_dataloader = create_dagan_dataloader(val_data['orig'], val_data['aug'], train_transform, batch_size)
...
trainer.train(data_loader=train_dataloader, epochs=epochs, val_dataloader=val_dataloader)
